...
will help get you started while the [guide for contributing to packages](https://github.com/atomeditor-io/atom/blob/master/docs/contributing-to-packages.md)
